   ...
   return (
      <div className="relative">
         <input
            ...
            value={value}
            id={id}
            className="block rounded-md px-6 pt-6 pb-1 w-full text-lg text-white bg-neutral-700 
            appearance-none focus:outline-none focus:ring-0 peer invalid:border-b-1"
            placeholder=""
         />
         <label
